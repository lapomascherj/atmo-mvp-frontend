...
interface KnowledgeOrganizerLayoutProps {
  children: React.ReactNode;
  sidebar?: React.ReactNode;
}

export const KnowledgeOrganizerLayout: React.FC<KnowledgeOrganizerLayoutProps> = ({ 
  children, 
  sidebar 
}) => {
  return (
...
export default KnowledgeOrganizerLayout; 